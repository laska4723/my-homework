...
alex.age = Math.floor((Date.now() - alex.dateOfBirth.getTime()) / millisecondsInYear);
jake.age = Math.floor((Date.now() - jake.dateOfBirth.getTime()) / millisecondsInYear);
john.age = Math.floor((Date.now() - john.dateOfBirth.getTime()) / millisecondsInYear);
bob.age = Math.floor((Date.now() - bob.dateOfBirth.getTime()) / millisecondsInYear);
